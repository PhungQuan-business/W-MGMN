...
class IntuitiveFuzzy(object):
	...
	def __init__(self, data, namefile, att_nominal_cate, delta, alpha, beta, B, num_delta, dis_tg):
	...
	def filter_incre(self):
		...
		start = time.time()
		# Filter attributes
		while round(dis_B - dis_C, 3) > 0.0035 :
		...
		# 	if round(dis_remove_cm - dis_B, 3) <= 0.000:
